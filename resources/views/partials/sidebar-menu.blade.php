...
<div class="pt-3 pb-1 px-3">
    <p class="text-xs font-semibold text-gray-400 uppercase tracking-wider">Pixabay</p>
</div>

@if(Route::has('pixabay.index'))
<a href="{{ route('pixabay.index') }}"
   class="flex items-center px-3 py-2 rounded-lg text-sm {{ request()->routeIs('pixabay.index') ? 'sidebar-active' : 'sidebar-hover' }}">
